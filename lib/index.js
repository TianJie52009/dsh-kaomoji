...
export function buildGuidance(config) {
  ...
  const modeLines = {
    auto: [
      "Use a Japanese kaomoji only when it genuinely improves a friendly, empathetic, playful, or warm reply.",
      "One per reply is usually enough; never force one, and never replace real content with it.",
    ],
    frequent: [
